...
import { BitPluginWeb3MQ } from '../src/index'
import { MessageListItem } from 'web3-mq'
...
const handleMessage = (event: any) => {
  ...
  const { messageList, msg_text: msgText } = client.message
  if (type === 'message.getList' && messageList) {
    message = [...messageList]
  }
